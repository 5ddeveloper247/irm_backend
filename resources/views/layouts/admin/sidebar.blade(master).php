        ...
        <ul class="nav flex-column p-3">
            ...
            <li class="nav-item">
                <a href="{{ route('audio_lectures') }}"
                    class="nav-link acc-link {{ request()->is('audio_lectures') ? 'active-nav' : '' }}">
            ...
            <li class="nav-item">
                <a href="{{ route('campaigns') }}"
                    class="nav-link acc-link {{ request()->is('campaigns') ? 'active-nav' : '' }}">
            ...
            <li class="nav-item">
                <a href="{{ route('books_library') }}"
                    class="nav-link acc-link {{ request()->is('books_library') ? 'active-nav' : '' }}">
            ...
            <li class="nav-item">
                <a href="{{ route('blogs') }}"
                    class="nav-link acc-link {{ request()->is('blogs') ? 'active-nav' : '' }}">
            ...
            <li class="nav-item">
                <a href="{{ route('gallery') }}"
                    class="nav-link acc-link {{ request()->is('gallery') ? 'active-nav' : '' }}">
            ...
            <li class="nav-item">
                <a href="{{ route('courses') }}"
                    class="nav-link acc-link {{ request()->is('courses') ? 'active-nav' : '' }}">
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center gap-2">
            ...
            <li class="nav-item">
                <a href="{{ route('news_events') }}"
                    class="nav-link acc-link {{ request()->is('news_events') ? 'active-nav' : '' }}">
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center gap-2">
            ...
            <li class="nav-item">
                <a href="{{ route('irm_settings') }}"
                    class="nav-link acc-link {{ request()->is('settings') ? 'active-nav' : '' }}">
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center gap-2">
            ...
            <li class="nav-item">
                <a href="{{ route('payments') }}"
                    class="nav-link acc-link {{ request()->is('payments') ? 'active-nav' : '' }}">
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center gap-2">
                            {{-- <i class="fa-solid fa-newspaper"></i> --}}
            ...
            <li class="nav-item">
                <a href="{{ route('bookorders') }}"
                    class="nav-link acc-link {{ request()->is('bookorders') ? 'active-nav' : '' }}">
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center gap-2">
            ...
            <li class="nav-item">
                <a href="{{ route('enrollCourses') }}"
                    class="nav-link acc-link {{ request()->is('enrollCourses') ? 'active-nav' : '' }}">
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center gap-2">
            ...
            <li class="nav-item">
                <a href="{{ route('viewContact') }}"
                    class="nav-link acc-link {{ request()->is('viewContact') ? 'active-nav' : '' }}">
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center gap-2">
            ...
            <li class="nav-item">
                <a href="{{ route('memberships') }}"
                    class="nav-link acc-link {{ request()->is('memberships') ? 'active-nav' : '' }}">
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center gap-2">
            ...
            <li class="nav-item">
                <a href="{{ route('youtube') }}"
                    class="nav-link acc-link {{ request()->is('youtube') ? 'active-nav' : '' }}">
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center gap-2">
            ...
            {{-- worklocations --}}
            <li class="nav-item">
                <a href="{{ route('worklocation') }}"
                    class="nav-link acc-link {{ request()->is('worklocation') ? 'active-nav' : '' }}">
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="d-flex align-items-center gap-2">
