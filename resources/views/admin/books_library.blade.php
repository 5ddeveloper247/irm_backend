...
@section('content')
                                            ...
                                            <div class="card-body">
                                                ...
                                                @php
                                                    $button = '<a href="javascript:void(0);" class="theme-btn d-flex align-items-center gap-1 py-2 px-3 rounded-2 text-white" 
                                                            data-bs-toggle="offcanvas" onclick="addNewBook();" ><!-- data-bs-toggle="offcanvas" data-bs-target="#addAudioCategory_canvas" -->
                                                                <i class="fa-solid fa-plus"></i>
                                                                Add New Book
                                                            </a>';
                                                    $filters = [
                                                        // get columns from library table
                                                        ['name' => 'book_title', 'type' => 'text', 'label' => 'Book Title', 'placeholder' => 'Search Book Title'],
                                                        ['name' => 'book_price', 'type' => 'text', 'label' => 'Price', 'placeholder' => 'Search Price'],
                                                        ['name' => 'book_date', 'type' => 'date', 'label' => 'Book Date'],
                                                        ['name' => 'book_status', 'type' => 'select', 'label' => 'Status', 'options' => [
                                                        ...
                                                        <table id="books_table" class="table">
                                                            ...
                                                            <thead style="background-color: #3259901c !important;">
                                                                <tr>
                                                                    ...
                                                                    <th class="text-start text-nowrap" scope="col">Book Title</th>
    ...
    <div style="max-width:33rem;" class="offcanvas offcanvas-end add-new-project-offcanvas" tabindex="-1"  id="addBook_canvas" aria-labelledby="offcanvas_add_label">
            ...
            <form id="book_form">
                ...
                <div class="row g-3">
                    ...
                    <div class="form-floating">
                        <input type="text" class="form-control" id="book_title" name="book_title" placeholder="Book Title" maxlength="50">
                        <label class="ms-2" for="book_title">Book Title</label>
                    </div>

                    <div class="form-floating">
                        <textarea class="form-control" id="book_description" name="book_description" placeholder="Book Description" maxlength="250" style="height:150px;"></textarea>
