                                            ...
                                            <div class="card-body">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="d-flex align-items-center flex-wrap row-gap-2 justify-content-sm-end">
                                                            ...
                                                            data-bs-toggle="offcanvas" onclick="addNewEnrollCourse();" ><!-- data-bs-toggle="offcanvas" data-bs-target="#addAudioCategory_canvas" -->
                                                                <i class="fa-solid fa-plus"></i>
                                                                Add New EnrollCourse
                                                            </a> --}}
                                                        </div>
                                                    </div>
                                                </div> 
                                                ...
                                                <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-4">
                                                    ...
                                                    <div class="table-responsive list-view-div w-100 mt-3"><!-- overflow-x:clip; -->
                                                        <table id="join_us_table" class="table">
                                                            ...
                                                            <thead style="background-color: #3259901c !important;">
                                                                <tr>
                                                                    ...
                                                                    <th class="text-start text-nowrap" scope="col">Subject</th>
...
@endsection
@push('js')
    <script src="{{asset('assets/customjs/script_join_us.js')}}"></script>
    <!-- <script>
