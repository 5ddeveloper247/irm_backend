                                                ...
                                                <div class="row align-items-center">
                                                    <div class="col-sm-4">
                                                        <div class="icon-form mb-3 mb-sm-0">
                                                            ...
                                                            <input type="text" id="search_filter" class="form-control"
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div
                                                            ...
                                                            data-bs-toggle="offcanvas" onclick="addNewEnrollCourse();" ><!-- data-bs-toggle="offcanvas" data-bs-target="#addPdfCategory_canvas" -->
