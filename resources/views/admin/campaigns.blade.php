...
@section('content')
                                                ...
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="d-flex align-items-center flex-wrap row-gap-2 justify-content-sm-end">
                                                            ...
                                                            data-bs-toggle="offcanvas" onclick="addNewCampaign();" ><!-- data-bs-toggle="offcanvas" data-bs-target="#addAudioCategory_canvas" -->
                                                        ...
                                                        <table id="campaign_table" class="table">
                                                            ...
                                                            <thead style="background-color: #3259901c !important;">
                                                                <tr>
                                                                    ...
                                                                    <th class="text-start text-nowrap" scope="col">Campaigns Title</th>
                                                                    <th class="text-start text-nowrap" scope="col">Target (PKR)</th>
    ...
    <div style="max-width:33rem;" class="offcanvas offcanvas-end add-new-project-offcanvas" tabindex="-1"  id="addCampaign_canvas" aria-labelledby="offcanvas_add_label">
            ...
            <form id="campaign_form">
                ...
                <div class="row g-3">
                    ...
                    <div class="form-floating">
                        <input type="text" class="form-control" id="campaign_title" name="campaign_title" placeholder="Campaign Title" maxlength="50">
                        <label class="ms-2" for="campaign_title">Campaign Title</label>
                    </div>

                    <div class="form-floating">
                        <input type="text" class="form-control" id="campaign_tags" name="campaign_tags" placeholder="Campaign Tags" maxlength="50">
                        <label class="ms-2" for="campaign_tags">Campaign Tags</label>
                    </div>
                    <span class="mt-0"><small>Add comma seperated tags here...</small></span>
                    
                    <div class="form-floating">
                        <textarea class="form-control" id="campaign_description" name="campaign_description" placeholder="Campaign Description" maxlength="250" style="height:150px;"></textarea>
                        <label class="ms-2" for="campaign_description">Campaign Description</label>
                    </div>

                    <div class="form-floating">
                        <input type="number" class="form-control" id="campaign_target_amount" name="campaign_target_amount" placeholder="Target Amount">
                ...
                <div class="d-flex justify-content-end mt-3">
                    ...
                    <button type="button" class="btn btn-purple" onclick="saveCampaign();" id="saveCampaign_btn">Add</button>
                </div>
            </form>
        </div>
    </div>
