...
@section('content')
            ...
            <ul style="width:78rem;"class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item fs-3" role="presentation">
                    <button class="nav-link" id="listing-tab" data-bs-toggle="tab" data-bs-target="#listing-tab-pane"
                        type="button" role="tab" aria-controls="listing-tab-pane" aria-selected="true">Gallery
                        List</button>
                </li>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                @php
                                                    ...
                                                    $filters = [
                                                        // get my page table gallery type
                                                        [
                                                            'name' => 'type_title',
                                                            'type' => 'text',
                                                            'label' => 'Type Title',
                                    ...
                                    <div class="schedule">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                {{-- include --}}
                                                @php
                                                    $button = '<a href="javascript:void(0);" class="theme-btn d-flex align-items-center gap-1 py-2 px-3 rounded-2 text-white" onclick="addNewGallery();">
                                                                <i class="fa-solid fa-plus"></i>
                                                                Add Gallery
                                                            </a>';
                                                    $filters = [
                                                        // get columns from gallery table
                                                        [
                                                            'name' => 'gallery_title',
                                                            'type' => 'text',
                                                            'label' => 'Gallery Name',
                                                        ...
                                                        ['name' => 'gallery_date', 'type' => 'date', 'label' => 'Date'],
                                                        [
                                                            'name' => 'gallery_status',
                                                            'type' => 'select',
                                                            'label' => 'Status',
        ...
        <div style="padding: 6%;" class="offcanvas-body">
            <form id="type_form">
                ...
                <div class="d-flex justify-content-end mt-3">
                    ...
                    <button type="button" class="btn btn-purple" onclick="saveGalleryType();"
                        id="addType_btn">Add</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <!-- Offcanvas Add Audio Category -->
    <div style="max-width:33rem;" class="offcanvas offcanvas-end add-new-project-offcanvas" tabindex="-1"
        id="addGallery_canvas" aria-labelledby="offcanvas_add_label">
        <div class="offcanvas-header">
        ...
        <div style="padding: 6%;" class="offcanvas-body">
            <form id="gallery_form">
                ...
                <div class="row g-3">
                    ...
                    <div class="form-floating">
                        <input type="text" class="form-control" id="gallery_title" name="gallery_title"
                            placeholder="Gallery Title" maxlength="50">
                        <label class="ms-2" for="gallery_title">Gallery Title</label>
                    </div>

                    <div class="form-floating">
                        <textarea class="form-control" id="gallery_description" name="gallery_description" placeholder="Gallery Description"
                            maxlength="250" style="height:150px;"></textarea>
                ...
                <div class="d-flex justify-content-end mt-3">
                    ...
                    <button type="button" class="btn btn-purple" onclick="saveGallery();"
                        id="saveGallery_btn">Add</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <script>
        ...
        document.querySelectorAll('.filterBtn').forEach(function(button) {
            button.addEventListener('click', function(event) {
                ...
                getGalleryTypesPageData(formValues);
