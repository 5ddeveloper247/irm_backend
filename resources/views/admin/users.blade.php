...
@section('content')
                                                ...
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="d-flex align-items-center flex-wrap row-gap-2 justify-content-sm-end">
                                                            <a href="javascript:void(0);" class="theme-btn d-flex align-items-center gap-1 py-2 px-3 rounded-2 text-white" data-bs-toggle="offcanvas" onclick="addNewUser();" ><!-- data-bs-toggle="offcanvas" data-bs-target="#addAudioCategory_canvas" -->
                                                        ...
                                                        <table id="users_table" class="table">
                                                            ...
                                                            <thead style="background-color: #3259901c !important;">
                                                                <tr>
                                                                    ...
                                                                    <th class="text-start text-nowrap" scope="col">User Name</th>
                                                                    <th class="text-start text-nowrap" scope="col">Email</th>
                                                                    <th class="text-start text-nowrap" scope="col">Created At</th>
    ...
    <div style="max-width:33rem;" class="offcanvas offcanvas-end add-new-project-offcanvas" tabindex="-1"  id="addUser_canvas" aria-labelledby="offcanvas_add_label">
        ...
        <div style="padding: 6%;" class="offcanvas-body">
            <form id="user_form">
                ...
                <div class="row g-3">
                    ...
                    <div class="form-floating">
                        <input type="text" class="form-control" id="username" name="username" placeholder="User Title" maxlength="50">
                        <label class="ms-2" for="username">User Name</label>
                    </div>

                    <div class="form-floating">
                        <input type="email" class="form-control" id="email" name="email" placeholder="User Tags" maxlength="100">
                    ...
                    @if($menu->route != 'sub-admins')
                        <div class="col-6">
                            <input class="" id="menu_{{$menu->id}}" type="checkbox" name="menus[]" value="{{$menu->id}}">
